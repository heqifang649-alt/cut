...
| TC-P1-VISION-CAPABILITY-DISCOVERY | Root PM / Eval | TC-P1-VISION-PROTOCOL-BOUNDARY | blocked provider availability | One bounded real-image discovery: `/models` 200; `gpt-5.6` Responses text 503 and Chat text 503. No provider/model capability conclusion or primary-model selection. |
