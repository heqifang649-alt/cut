...
| P2-SCHEDULER-SEMANTIC-EVIDENCE | Treatment B implementation | P1 Vision Gate | next | Integrate existing semantic-evidence.v1 fields into deterministic Scheduler with minimal conservative Pilot-only filtering/ranking; preserve Control A and flags off by default. |
